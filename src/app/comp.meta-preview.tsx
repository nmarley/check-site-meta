    ...
    return (
      <Tabs
        ...
        tabs={[
          ...
          tab("Discord", <IcBaselineDiscord
            style={{ "--color": "#5865F2" } as CSSProperties}
            className="transition group-hover:text-[var(--color)] group-data-active:text-[var(--color)]" />, <ComingSoon />),
          tab("Google", <>
            <LogosGoogleIcon className="p-0.5" />
          </>, <ComingSoon />),
          tab("Facebook", <IcBaselineFacebook
            style={{ "--color": "#1877f2" } as CSSProperties}
            className="transition group-hover:text-[var(--color)] group-data-active:text-[var(--color)]" />, <ComingSoon />),
          tab("Whatsapp", <IcBaselineWhatsapp
            style={{ "--color": "#65D072" } as CSSProperties}
            className="transition group-hover:text-[var(--color)] group-data-active:text-[var(--color)]" />, <ComingSoon />),
          tab("Telegram", <IcBaselineTelegram
